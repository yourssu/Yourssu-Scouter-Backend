...
import com.yourssu.scouter.member.excelsheet.implement.getFlexibleLocalDateSafe
import com.yourssu.scouter.member.excelsheet.implement.getFormattedStringSafe
import com.yourssu.scouter.member.excelsheet.implement.getStringSafe
...
data class ColumnNumberMapping(
    ...
    companion object {
        fun forState(state: com.yourssu.scouter.member.core.implement.MemberState): ColumnNumberMapping =
            when (state) {
                com.yourssu.scouter.member.core.implement.MemberState.ACTIVE -> ACTIVE_MEMBER
                com.yourssu.scouter.member.core.implement.MemberState.INACTIVE -> INACTIVE_MEMBER
                com.yourssu.scouter.member.core.implement.MemberState.COMPLETED -> COMPLETED_MEMBER
                com.yourssu.scouter.member.core.implement.MemberState.GRADUATED -> GRADUATED_MEMBER
                com.yourssu.scouter.member.core.implement.MemberState.WITHDRAWN ->
