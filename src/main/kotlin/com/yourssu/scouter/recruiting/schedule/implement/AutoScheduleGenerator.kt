...
class AutoScheduleGenerator {
    ...
    private fun calculateMinPenalty(
        ...
        return when (strategy) {
            is com.yourssu.scouter.recruiting.schedule.implement.strategy.DistributedDayStrategy -> {
                maxOf(0L, applicants.size.toLong() - allDates.size)
            }
            is com.yourssu.scouter.recruiting.schedule.implement.strategy.ConcentratedDayStrategy -> {
