...
import com.yourssu.scouter.recruiting.support.implement.util.StrategyMapper
...
class AutoScheduleGenerator {
    ...
    private fun calculateMinPenalty(
        ...
        return when (strategy) {
            is com.yourssu.scouter.recruiting.recruiter.implement.strategy.DistributedDayStrategy -> {
                maxOf(0L, applicants.size.toLong() - allDates.size)
            }
            is com.yourssu.scouter.recruiting.recruiter.implement.strategy.ConcentratedDayStrategy -> {
