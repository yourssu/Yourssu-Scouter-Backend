...
import com.yourssu.scouter.hrms.support.implement.exception.ExcelParseFailedException
import com.yourssu.scouter.hrms.support.implement.getFlexibleLocalDateSafe
...
data class ColumnNumberMapping(
    ...
    companion object {
        fun forState(state: com.yourssu.scouter.hrms.member.implement.MemberState): ColumnNumberMapping =
            when (state) {
                com.yourssu.scouter.hrms.member.implement.MemberState.ACTIVE -> ACTIVE_MEMBER
                com.yourssu.scouter.hrms.member.implement.MemberState.INACTIVE -> INACTIVE_MEMBER
                com.yourssu.scouter.hrms.member.implement.MemberState.COMPLETED -> COMPLETED_MEMBER
                com.yourssu.scouter.hrms.member.implement.MemberState.GRADUATED -> GRADUATED_MEMBER
                com.yourssu.scouter.hrms.member.implement.MemberState.WITHDRAWN ->
